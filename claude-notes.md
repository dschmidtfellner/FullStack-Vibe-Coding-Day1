...
### Next Steps
- Update timestamp validation logic in SleepLogModal to use child's perspective
- Update display logic throughout the app to use Child Local Time
- Update "day before" bedtime logic to use child's midnight
- Update all timestamp comparisons to work in Child Local Time space
...
- All validation and display logic should work with these normalized timestamps
